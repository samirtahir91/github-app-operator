...
import (
	...
	webhookgithubappv1 "github-app-operator/internal/webhook/v1"
...
func main() {
	...
	if os.Getenv("ENABLE_WEBHOOKS") == "true" {
		if err = webhookgithubappv1.SetupGithubAppWebhookWithManager(mgr); err != nil {
