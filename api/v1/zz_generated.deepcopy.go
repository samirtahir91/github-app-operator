...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RestartPodsSpec) DeepCopyInto(out *RestartPodsSpec) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RestartPodsSpec.
func (in *RestartPodsSpec) DeepCopy() *RestartPodsSpec {
	if in == nil {
		return nil
	}
	out := new(RestartPodsSpec)
